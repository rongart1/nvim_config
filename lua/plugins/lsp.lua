    ...
    config = function()
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('gta', vim.lsp.buf.code_action, 'Goto Code Action', { 'n', 'x' })

          map('gtr', require('telescope.builtin').lsp_references, 'Goto References')

          map('gti', require('telescope.builtin').lsp_implementations, 'Goto Implementation')

          map('gtd', require('telescope.builtin').lsp_definitions, 'Goto Definition')
          ...
          map('gtt', require('telescope.builtin').lsp_type_definitions, 'Goto Type Definition')
      ...
      local servers = {
        ...
        pyright = {
          settings = {
            python = {
              venvPath = '.', -- points to folder containing venv
              venv = './venv/bin/python', -- name of the venv folder
              analysis = {
